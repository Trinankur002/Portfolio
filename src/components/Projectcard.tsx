...
function Projectcard({
    ...
    return (
        <div className="bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden group h-full border border-gray-700 hover:border-gray-600">
            {/* Project Header with Category and Status */}
            <div className="flex justify-between items-center px-4 py-3 border-b border-gray-700 bg-gradient-to-r from-gray-800 to-gray-750">
                {/* Category Badge */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                        {demoLink && (
                            <a
                                ...
                                className="flex-1 bg-teal-600 hover:bg-teal-700 text-white text-center py-2 px-3 sm:px-4 rounded-lg text-sm font-medium transition-colors duration-300 flex items-center justify-center gap-2"
                            >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`${demoLink ? 'flex-1' : 'w-full'} border-2 border-gray-600 hover:border-teal-400 text-gray-300 hover:text-teal-400 text-center py-2 px-3 sm:px-4 rounded-lg text-sm font-medium transition-colors duration-300 flex items-center justify-center gap-2`}
                        >
