...
function App() {
  ...
  const { displayText: animatedName } = useTypewriter({
    text: `Hello, I'm ${AboutMe.name}`,
    speed: 50,
    cursorChar: '|',
    showCursor: true,
  });
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <section ref={sectionRef} className="py-12 sm:py-16 md:py-24 px-4 sm:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent min-h-[7rem] sm:min-h-[8rem] md:min-h-[9rem]">
              {animatedName}
            </h1>
            ...
            {/* About Me Terminal */}
            <div ref={aboutSectionRef} id="about" className="mb-8 sm:mb-12">
